  ...
  methods: {
    async getMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/movie/now_playing?api_key=4a7f07ee852309cd38576cb75989d50a&language=en-US&page=1`
      )
      ...
      // console.log('works every action');
    },
    async getSearchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=4a7f07ee852309cd38576cb75989d50a&language=en-US&page=1&query=${this.searchInput}`
      )
      const result = await data
      result.data.results.forEach((movie) => {
